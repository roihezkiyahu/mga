...
class GraphDetecor:
    ...
    def reformat_boxes(self, box_torch, img, res, confs):
        ...
        if box_torch_no_label[0, 4] == 0:
            condition1 = box_torch_no_label[:, 0] <= box_torch_no_label[0, 0] + box_torch_no_label[0, 2] / 2
            condition2 = box_torch_no_label[:, 1] >= box_torch_no_label[0, 1] - box_torch_no_label[0, 3] / 2
